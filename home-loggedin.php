...
<body>
    ...
    <div>
    	<button class="buttonprofile" id="buttonprofile" name="buttonprofile" onclick="window.location.replace('profile.html')"><img id="profile" src="profile.png"></img></button>
    </div>
	<div class="title">
	...
	<img id="vector1" src="Vector-2.png"></img>
	<img id="vector2" src="Gelbiru.png"></img>
	<img id="vector3" src="Hightlight.png"></img>
	<div>
		<button class="button1" id="button1" name="button1" onclick="window.location.replace('packages.php')"><b>BOOK NOW</b></button>
	</div>
	<div id="pack5"></div>
	<div id="pack6"></div>
	<img id="vector4" src="profil.png"></img>
	<img id="vector5" src="profil.png"></img>
	<div>
		<div class="text5">Jhon Wick</div>
			<div class="text7">My dog really love it, HelloPet is the best place to grooming your pet</div>
			<img id="vector6" src="quote.png"></img>
			<div>
				<button class="button2" id="button2" name="button2" onclick="window.location.replace('swipe.html')"><img id="swipe" src="SWIPE-2.png"></img></button>
		...
		<div class="text6">Ryder</div>
			...
			<img id="vector7" src="quote.png"></img>
			<div>
				<button class="button3" id="button3" name="button3" onclick="window.location.replace('swipe.html')"><img id="swipe-1" src="SWIPE.png"></img></button>
