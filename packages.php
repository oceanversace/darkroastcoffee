...
<body>
    ...
    <div>
    <button class="buttonprofile" id="buttonprofile" name="buttonprofile" onclick="window.location.href='myprofile.php'"><img id="profile" src="img/profile.png"></img>
    </div>
	...
	<div id="pack2">
		...
		<button class="button2" id="button2" name="button2" onclick="window.location.href='petdetails.php'"><b>BOOK</b></button>
	<div id="pack3">
		...
		<button class="button3" id="button3" name="button2" onclick="window.location.href='petdetails.php'"><b>BOOK</b></button>
	</div>
	<div id="pack1">
		<div class="square">
			...
			<button class="button1" id="button1" name="button1" onclick="window.location.href='petdetails.php'"><b>BOOK</b></button>
		</div>
	</div>
	<div class="container">
