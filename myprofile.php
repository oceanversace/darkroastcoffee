...
<head>
	...
	<title>My Profile HelloPet</title>
...
<body>
	...
	<div class="box1">
		...
		<p class="title"><b>MY PROFILE</b></p>
		<div class="line"></div>
		<p class="nm">Name</p>
		<p class="name" id="name" name="name"><?=$res["nama"]?></p> <!--nama disesuaikan-->
		<p class="unm">Username</p>
		<p class="user-name" id="user-name" name="user-name"><?=$res["username"]?></p> <!--username disesuaikan-->
		<p class="mail">Email</p>
		<p class="user-email" id="user-email" name="user-email" type="email"><?=$res["email"]?></p> <!--email disesuaikan-->
		<p class="phn-num">Phone</p>
		<p class="phone" id="phone" name="phone"><?=$res["no_telp"]?></p> <!--nomor disesuaikan-->
		<p class="adrs">Address</p>
		<p class="address" id="address" name="address"><?=$res["alamat"]?></p> <!--alamat disesuaikan-->
	</div>
	<footer id="foot">
		<div>
