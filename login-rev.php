...
<head>
  ...
  <style>
    ...
    .underline-title {
          background: -webkit-linear-gradient(right, #f77be7, #c02ea0);
          height: 2px;
    ...
    .form-border {
        background: -webkit-linear-gradient(right, #f77bf7, #c02ead);
        height: 1px;
        width: 100%;
    }
    .form-content {
    ...
    #submit-btn {
        background: -webkit-linear-gradient(right, #e97bf7, #bd2db1);
        border: none;
        border-radius: 21px;
